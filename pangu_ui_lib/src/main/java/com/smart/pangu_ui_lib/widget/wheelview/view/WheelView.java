package com.smart.pangu_ui_lib.widget.wheelview.view;
...
import com.smart.pangu_ui_lib.widget.wheelview.timer.SmoothScrollTimerTask;
...
public class WheelView extends View {
    ...
    public final Object getCurrentItem() {
        ...
        return adapter.getItem(getCurrentItemIndex());
    }
        ...
        if (onItemSelectedListener != null) {
            postDelayed(new Runnable() {
                @Override
                public void run() {
                    onItemSelectedListener.onItemSelected(getCurrentItemIndex(),adapter.getItem(getCurrentItemIndex()));
                }
            }, 200L);
        }
    }
